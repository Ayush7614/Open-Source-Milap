# Contribution Guidelines [![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/Ayush7614/Open-Source-Milap/issues) 🤝🏽🍀:
...
git clone https://github.com/<your_username>/Open-Source-Milap.git
...
git remote add upstream https://github.com/Ayush7614/Open-Source-Milap.git 
...
- Comment on any existing [issue(s)](https://github.com/Ayush7614/Open-Source-Milap/issues) raised by *project maintainers*. Otherwise raise a [new issue](https://github.com/Ayush7614/Open-Source-Milap/issues/new).
...
*9.* Voila :exclamation: You have made a PR to the Open-Source-Milap :boom: . Sit back patiently and relax while the project maintainers review your PR. Please understand at times the time can vary from a few hours to a few days.
